...
var LumenMintableToken = artifacts.require('../contracts/tokens/LumenMintableToken.sol');

contract('LumenMintableToken', function(accounts) {
  let token;
  beforeEach(async function() {
    token = await LumenMintableToken.new();
  });
